...
import com.f2i_consulting.fetpapi.Energistics.Etp.v12.Protocol.Store.GetDataObjectsResponse;
...
public class MyOwnStoreProtocolHandlers extends StoreHandlers {
	...
	public MyOwnStoreProtocolHandlers(AbstractSession mySession, DataObjectRepository repo) {
		super(mySession);
		repo_ = repo;
	}
	...
	public void on_GetDataObjectsResponse(GetDataObjectsResponse msg, long correlationId){
		for (DataObject dataObj : msg.getDataObjects().values()) {
			...
			repo_.addOrReplaceGsoapProxy(dataObj.getData(), dataObj.getResource().getDataObjectType());
		}
	}
}
